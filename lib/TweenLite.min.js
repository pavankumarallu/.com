(function (m) {
    var G = function (a) {
        ...
        C = function (a, c, b, k) {
            ...
            this.check = function (c) {
                for (var f = e.length, h = 0, n; -1 < --f; ) (n = w[e[f]] || new C(e[f])).gsClass ? (d[f] = n.gsClass) : (h++, c && n.sc.push(this));
                if (0 === h && b) {
                    var c = ("com.greensock." + a).split("."),
                        f = c.pop(),
                        j = (G(c.join("."))[f] = this.gsClass = b.apply(b, d));
                    k &&
                        (((m.GreenSockGlobals || m)[f] = j),
                        "function" === typeof define && define.amd
                            ? define((m.GreenSockAMDPath ? m.GreenSockAMDPath + "/" : "") + a.split(".").join("/"), [], function () {
                                  return j;
                              })
    ...
    m._gsDefine = function (a, c, b, k) {
        return new C(a, c, b, k);
    };
    var I = [0, 0, 1, 1],
        D = [],
        t = r(
    ...
    d.getRatio = function (a) {
        ...
        var c = this._type,
            b = this._power,
            k = 1 === c ? 1 - a : 2 === c ? a : 0.5 > a ? 2 * a : 2 * (1 - a);
        1 === b ? (k *= k) : 2 === b ? (k *= k * k) : 3 === b ? (k *= k * k * k) : 4 === b && (k *= k * k * k * k);
        return 1 === c ? 1 - k : 2 === c ? k : 0.5 > a ? k / 2 : 1 - k / 2;
    };
    p = ["Linear", "Quad", "Cubic", "Quart", "Quint"];
    for (j = p.length; -1 < --j; )
        (d = r("easing." + p[j], null, !0)), (B = r("easing.Power" + j, null, !0)), (d.easeOut = B.easeOut = new t(null, null, 1, j)), (d.easeIn = B.easeIn = new t(null, null, 2, j)), (d.easeInOut = B.easeInOut = new t(null, null, 3, j));
    r("easing.Strong", l.easing.Power4, !0);
    l.easing.Linear.easeNone = l.easing.Linear.easeIn;
    var J = r("events.EventDispatcher", function (a) {
        this._listeners = {};
        this._eventTarget = a || this;
    });
    d = J.prototype;
    d.addEventListener = function (a, c, b, k, e) {
        var e = e || 0,
            d = this._listeners[a],
            i = 0,
            f;
        null == d && (this._listeners[a] = d = []);
        for (f = d.length; -1 < --f; ) (a = d[f]), a.c === c ? d.splice(f, 1) : 0 === i && a.pr < e && (i = f + 1);
        d.splice(i, 0, { c: c, s: b, up: k, pr: e });
    };
    ...
    d.dispatchEvent = function (a) {
        ...
        if (c) for (var b = c.length, k = this._eventTarget, d; -1 < --b; ) (d = c[b]), d.up ? d.c.call(d.s || k, { type: a, target: k }) : d.c.call(d.s || k);
    };
    var y = m.requestAnimationFrame,
    ...
    p = ["ms", "moz", "webkit", "o"];
    for (j = p.length; -1 < --j && !y; ) (y = m[p[j] + "RequestAnimationFrame"]), (E = m[p[j] + "CancelAnimationFrame"] || m[p[j] + "CancelRequestAnimationFrame"]);
    r("Ticker", function (a, c) {
        var b = this,
            k = K(),
            d = !1 !== c && y,
            g,
            ...
            n,
            j = function () {
                null != f && (!d || !E ? m.clearTimeout(f) : E(f), (f = null));
            },
            l = function (a) {
                b.time = (K() - k) / 1e3;
                if (!g || b.time >= n || !0 === a) b.frame++, (n = b.time > n ? b.time + h - (b.time - n) : b.time + h - 0.001), n < b.time + 0.001 && (n = b.time + 0.001), b.dispatchEvent("tick");
                !0 !== a && (f = i(l));
            };
        J.call(b);
        ...
        this.fps = function (a) {
            ...
            i =
                0 === g
                    ...
                    : !d || !y
                    ? function (a) {
                          return m.setTimeout(a, (1e3 * (n - b.time) + 1) >> 0 || 1);
                      }
                    : y;
            j();
            f = i(l);
    ...
    d = l.Ticker.prototype = new l.events.EventDispatcher();
    d.constructor = l.Ticker;
    var q = r("core.Animation", function (a, c) {
            this.vars = c || {};
            ...
            if (u) {
                H || (s.tick(), (H = !0));
                var b = this.vars.useFrames ? x : u;
                b.insert(this, b._time);
                this.vars.paused && this.paused(!0);
            }
        }),
        s = (q.ticker = new l.Ticker());
    d = q.prototype;
    ...
    d.eventCallback = function (a, c, b, d) {
        ...
        if ("on" === a.substr(0, 2)) {
            ...
            else if (((this.vars[a] = c), (this.vars[a + "Params"] = b), (this.vars[a + "Scope"] = d), b)) for (var e = b.length; -1 < --e; ) "{self}" === b[e] && ((b = this.vars[a + "Params"] = b.concat()), (b[e] = this));
    ...
    d.totalTime = function (a, c) {
        ...
        if (this._timeline) {
            ...
            if (
                ...
                (this._dirty && this.totalDuration(),
                a > this._totalDuration && (a = this._totalDuration),
                (this._startTime = (this._paused ? this._pauseTime : this._timeline._time) - (!this._reversed ? a : this._totalDuration - a) / this._timeScale),
                this._timeline._dirty || this._uncache(!1),
                !this._timeline._active)
            )
    ...
    d.paused = function (a) {
        ...
        a !== this._paused &&
            this._timeline &&
            (!a && this._timeline.smoothChildTiming && ((this._startTime += this._timeline.rawTime() - this._pauseTime), this._uncache(!1)),
            (this._pauseTime = a ? this._timeline.rawTime() : null),
            (this._paused = a),
            (this._active = !this._paused && 0 < this._totalTime && this._totalTime < this._totalDuration));
        this._gc && (a || this._enabled(!0, !1));
        return this;
    };
    l = r("core.SimpleTimeline", function (a) {
        q.call(this, 0, a);
    ...
    var h = r(
        ...
        function (a, c, b) {
            ...
            this.target = a;
            this._overwrite = null == this.vars.overwrite ? L[h.defaultOverwrite] : "number" === typeof this.vars.overwrite ? this.vars.overwrite >> 0 : L[this.vars.overwrite];
            if ((a instanceof Array || a.jquery) && "object" === typeof a[0]) {
                ...
                for (a = 0; a < this._targets.length; a++)
                    (b = this._targets[a]),
                        b.jquery
                            ? (this._targets.splice(a--, 1), (this._targets = this._targets.concat(b.constructor.makeArray(b))))
                            : ((this._siblings[a] = z(b, this, !1)), 1 === this._overwrite && 1 < this._siblings[a].length && F(b, this, null, 1, this._siblings[a]));
            } else (this._propLookup = {}), (this._siblings = z(a, this, !1)), 1 === this._overwrite && 1 < this._siblings.length && F(a, this, null, 1, this._siblings);
    ...
    h.version = 1.651;
    h.defaultEase = d._ease = new t(null, null, 1, 1);
    ...
    var M = (h._plugins = {}),
        ...
        x = (q._rootFramesTimeline = new l()),
        u = (q._rootTimeline = new l());
    u._startTime = s.time;
    x._startTime = s.frame;
    u._active = x._active = !0;
    q._updateRoot = function () {
        u.render((s.time - u._startTime) * u._timeScale, !1, !1);
        x.render((s.frame - x._startTime) * x._timeScale, !1, !1);
        if (!(s.frame % 120)) {
            var a, c, b;
            for (b in v) {
                c = v[b].tweens;
    ...
    s.addEventListener("tick", q._updateRoot);
    var z = function (a, c, b) {
            var d = a._gsTweenID,
                e;
            if (!v[d || (a._gsTweenID = d = "t" + O++)]) v[d] = { target: a, tweens: [] };
            if (c && ((a = v[d].tweens), (a[(e = a.length)] = c), b)) for (; -1 < --e; ) a[e] === c && a.splice(e, 1);
            return v[d].tweens;
        },
        F = function (a, c, b, d, e) {
            var g, i, f;
            if (1 === d || 4 <= d) {
                a = e.length;
                for (g = 0; g < a; g++)
                    if ((f = e[g]) !== c) f._gc || (f._enabled(!1, !1) && (i = !0));
                    else if (5 === d) break;
                return i;
            }
            var h = c._startTime + 1e-10,
                n = [],
                j = 0,
                l = 0 === c._duration,
                m;
            for (g = e.length; -1 < --g; )
                if (!((f = e[g]) === c || f._gc || f._paused))
                    f._timeline !== c._timeline
                        ? ((m = m || N(c, 0, l)), 0 === N(f, m, l) && (n[j++] = f))
                        : f._startTime <= h && f._startTime + f.totalDuration() / f._timeScale + 1e-10 > h && (((l || !f._initted) && 2e-10 >= h - f._startTime) || (n[j++] = f));
            for (g = j; -1 < --g; ) if (((f = n[g]), 2 === d && f._kill(b, a) && (i = !0), 2 !== d || (!f._firstPT && f._initted))) f._enabled(!1, !1) && (i = !0);
            return i;
        },
        N = function (a, c, b) {
            ...
            g /= e;
            return g > c ? g - c : (b && g === c) || (!a._initted && 2e-10 > g - c) ? 1e-10 : (g += a.totalDuration() / a._timeScale / e) > c ? 0 : g - c - 1e-10;
        };
    d._init = function () {
        this.vars.startAt && ((this.vars.startAt.overwrite = 0), (this.vars.startAt.immediateRender = !0), h.to(this.target, 0, this.vars.startAt));
        var a, c;
        this._ease =
            this.vars.ease instanceof t
                ? this.vars.easeParams instanceof Array
                    ? this.vars.ease.config.apply(this.vars.ease, this.vars.easeParams)
                    : this.vars.ease
                : "function" === typeof this.vars.ease
                ? new t(this.vars.ease, this.vars.easeParams)
                : h.defaultEase;
        ...
        for (e in this.vars) {
            if (P[e]) {
                if ("onStartParams" === e || "onUpdateParams" === e || "onCompleteParams" === e || "onReverseCompleteParams" === e || "onRepeatParams" === e)
                    if ((h = this.vars[e])) for (g = h.length; -1 < --g; ) "{self}" === h[g] && ((h = this.vars[e] = h.concat()), (h[g] = this));
            } else if (M[e] && (f = new M[e]())._onInitTween(a, this.vars[e], this)) {
                this._firstPT = j = { _next: this._firstPT, t: f, p: "setRatio", s: 0, c: 1, f: !0, n: e, pg: !0, pr: f._priority };
                for (g = f._overwriteProps.length; -1 < --g; ) c[f._overwriteProps[g]] = this._firstPT;
                if (f._priority || f._onInitAllProps) i = !0;
                if (f._onDisable || f._onEnable) this._notifyPluginsOfEnabled = !0;
            } else
                (this._firstPT = c[e] = j = { _next: this._firstPT, t: a, p: e, f: "function" === typeof a[e], n: e, pg: !1, pr: 0 }),
                    (j.s = !j.f ? parseFloat(a[e]) : a[e.indexOf("set") || "function" !== typeof a["get" + e.substr(3)] ? e : "get" + e.substr(3)]()),
                    (g = this.vars[e]),
                    (j.c = "number" === typeof g ? g - j.s : "string" === typeof g && "=" === g.charAt(1) ? parseInt(g.charAt(0) + "1") * Number(g.substr(2)) : Number(g) || 0);
            j && j._next && (j._next._prev = j);
        }
        return d && this._kill(d, a) ? this._initProps(a, c, b, d) : 1 < this._overwrite && this._firstPT && 1 < b.length && F(a, this, c, this._overwrite, b) ? (this._kill(c, a), this._initProps(a, c, b, d)) : i;
    };
    d.render = function (a, c, b) {
        ...
        if (a >= this._duration) {
            ...
            var i = a / this._duration,
                f = this._easeType,
                h = this._easePower;
            if (1 === f || (3 === f && 0.5 <= i)) i = 1 - i;
            3 === f && (i *= 2);
            1 === h ? (i *= i) : 2 === h ? (i *= i * i) : 3 === h ? (i *= i * i * i) : 4 === h && (i *= i * i * i * i);
            this.ratio = 1 === f ? 1 - i : 2 === f ? i : 0.5 > a / this._duration ? i / 2 : 1 - i / 2;
        ...
        if (this._time !== d || b) {
            ...
            g && !this._gc && (e && (this._timeline.autoRemoveChildren && this._enabled(!1, !1), (this._active = !1)), c || (this.vars[g] && this.vars[g].apply(this.vars[g + "Scope"] || this, this.vars[g + "Params"] || D)));
        }
    };
    d._kill = function (a, c) {
        ...
        var c = c || this._targets || this.target,
            ...
            f,
            j;
        if ((c instanceof Array || c.jquery) && "object" === typeof c[0]) for (b = c.length; -1 < --b; ) this._kill(a, c[b]) && (h = !0);
        else {
            if (this._targets)
            ...
            if (g)
                for (e in ((f = a || g), (j = a != d && "all" != d && a != g && (null == a || !0 != a._tempKill)), f)) {
                    if ((b = g[e])) {
    ...
    d._enabled = function (a, c) {
        if (a && this._gc)
            if (this._targets) for (var b = this._targets.length; -1 < --b; ) this._siblings[b] = z(this._targets[b], this, !0);
            else this._siblings = z(this.target, this, !0);
        q.prototype._enabled.call(this, a, c);
    ...
    h.killTweensOf = h.killDelayedCallsTo = function (a, c) {
        for (var b = h.getTweensOf(a), d = b.length; -1 < --d; ) b[d]._kill(c, a);
    };
    ...
    d._addTween = function (a, c, b, d, e, g) {
        var h;
        if (null != d && (h = "number" === typeof d || "=" !== d.charAt(1) ? Number(d) - b : parseInt(d.charAt(0) + "1") * Number(d.substr(2))))
            (this._firstPT = a = { _next: this._firstPT, t: a, p: c, s: b, c: h, f: "function" === typeof a[c], n: e || c, r: g }), a._next && (a._next._prev = a);
    };
    ...
    A.activate = function (a) {
        for (var c = a.length; -1 < --c; ) a[c].API === A.API && (h._plugins[new a[c]()._propName] = a[c]);
        return !0;
    };
    if ((p = m._gsQueue)) {
        for (j = 0; j < p.length; j++) p[j]();
        for (d in w) w[d].def || console.log("Warning: TweenLite encountered missing dependency: com.greensock." + d);
    }
})(window);
