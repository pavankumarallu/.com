(this.createjs = this.createjs || {}),
    ...
    (function () {
        ...
        (e.DELIMITER = "|"),
            ...
            (e.sendFileLoadEvent = function (a) {
                if (e.preloadHash[a])
            ...
            (e.registerSound = function (a, c, d, f, g) {
                ...
                if (
                    (null != j &&
                        ...
                        b.create(h.src, i),
                        null != d && isNaN(d) ? (d.channels = h.data.channels = i || b.maxPerChannel()) : (d = h.data = i || b.maxPerChannel()),
                        null != j.tag ? (h.tag = j.tag) : j.src && (h.src = j.src),
                        null != j.completeHandler && (h.completeHandler = j.completeHandler),
                        j.type && (h.type = j.type)),
                    0 != f)
                )
                    if ((e.preloadHash[h.src] || (e.preloadHash[h.src] = []), e.preloadHash[h.src].push({ src: a, id: c, data: d }), 1 == e.preloadHash[h.src].length)) null == g && (g = ""), e.activePlugin.preload(h.src, j, g);
            ...
            (e.setVolume = function (a) {
                ...
                if (((a = Math.max(0, Math.min(1, a))), (e.masterVolume = a), !this.activePlugin || !this.activePlugin.setVolume || !this.activePlugin.setVolume(a)))
                    for (var b = this.instances, c = 0, d = b.length; d > c; c++) b[c].setMasterVolume(a);
            }),
            ...
            (e.playInstance = function (a, b, c, d, f, g, h) {
                if (
                    (b instanceof Object && ((c = b.delay), (d = b.offset), (f = b.loop), (g = b.volume), (h = b.pan)),
            ...
            (f.getSlot = function (b) {
                for (var c, d, e = 0, f = this.max; f > e; e++) {
                    ...
                    (b != a.INTERRUPT_NONE || c.playState == a.PLAY_FINISHED) &&
                        (0 != e
                            ? c.playState == a.PLAY_FINISHED || c.playState == a.PLAY_INTERRUPTED || c.playState == a.PLAY_FAILED
                                ? (d = c)
                                : ((b == a.INTERRUPT_EARLY && c.getPosition() < d.getPosition()) || (b == a.INTERRUPT_LATE && c.getPosition() > d.getPosition())) && (d = c)
                            : (d = c));
                }
        ...
        (b.capabilities = null),
            ...
            (b.generateCapabilities = function () {
                if (null == b.capabilities) {
                    ...
                    b.context.destination.numberOfChannels < 2 && (b.capabilities.panning = !1),
            ...
            (b.beginPlaying = function (a, b, c, d) {
                return null != window.createjs && this.src
                    ? ((this.offset = a / 1e3),
                      ...
                      (this.volume = c),
                      (this.pan = d),
                      this.owner.isPreloadComplete(this.src) ? (this.handleSoundReady(null), this.sendEvent("succeeded"), 1) : (this.playFailed(), void 0))
                    : void 0;
            }),
            (b.pause = function () {
                ...
                return (
                    ...
                    0 != this.remainingLoops
                        ? (this.remainingLoops--,
                          ...
                          this.sendEvent("loop"),
                          void 0)
                        : (null != window.createjs && ((this.playState = createjs.Sound.PLAY_FINISHED), this.cleanUp(), this.sendEvent("complete")), void 0)
                );
            }),
        ...
        (b.src = null),
            ...
            (b.beginPlaying = function (a, b, c, d) {
                ...
                return null == e
                    ...
                    : (e.addEventListener(createjs.HTMLAudioPlugin.AUDIO_ENDED, this.endedHandler, !1),
                      ...
                      (this.remainingLoops = b),
                      4 !== e.readyState
                          ? (e.addEventListener(createjs.HTMLAudioPlugin.AUDIO_READY, this.readyHandler, !1), e.addEventListener(createjs.HTMLAudioPlugin.AUDIO_STALLED, this.stalledHandler, !1), (e.preload = "auto"), e.load())
                          : this.handleSoundReady(null),
            ...
            (b.handleSoundReady = function () {
                if (null != window.createjs) {
                    ...
                    this.offset > 0 && (this.tag.currentTime = 0.001 * this.offset),
