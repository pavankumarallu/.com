        ...
        (a.NONE = 0),
            ...
            (b.initialize = function (b, c, d) {
                (this.target = this._target = b),
                    c && ((this._useTicks = c.useTicks), (this.ignoreGlobalPause = c.ignoreGlobalPause), (this.loop = c.loop), c.onChange && this.addEventListener("change", c.onChange), c.override && a.removeTweens(b)),
                    (this.pluginData = d || {}),
                    (this._curQueueProps = {}),
            ...
            (b.setPosition = function (a, b) {
                ...
                return (
                    0 != b && this._actions.length > 0 && (this._useTicks ? this._runActions(c, c) : 1 == b && e > c ? (e != this.duration && this._runActions(e, this.duration), this._runActions(0, c, !0)) : this._runActions(e, c)),
                    d && this.setPaused(!0),
