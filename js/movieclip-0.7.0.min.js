        ...
        (a.INDEPENDENT = "independent"),
            ...
            (b._updateTimeline = function () {
                ...
                if (
                    ...
                    c
                        ? b.setPosition(this.startPosition + (this.mode == a.SINGLE_FRAME ? 0 : this._synchOffset), createjs.Tween.NONE)
                        : b.setPosition(this._prevPos < 0 ? 0 : this._prevPosition, this.actionsEnabled ? null : createjs.Tween.NONE),
                    (this._prevPosition = b._prevPosition),
                    this._prevPos != b._prevPos)
                ) {
                    this.currentFrame = this._prevPos = b._prevPos;
                    for (var d in this._managed) this._managed[d] = 1;
            ...
            (b.Container__getBounds = b._getBounds),
