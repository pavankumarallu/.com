        ...
        (c.FILE_PATTERN = /^(?:(\w+:)\/{2}(\w+(?:\.\w+)*\/?))?([/.]*?(?:[^?]+)?\/)?((?:[^/?]+)\.(\w+))(?:\?(\S+)?)?$/),
            ...
            (b._sendProgress = function (a) {
                if (!this._isCanceled()) {
                    var b = null;
                    "number" == typeof a
                        ? ((this.progress = a), (b = new createjs.Event("progress")), (b.loaded = this.progress), (b.total = 1))
                        : ((b = a), (this.progress = a.loaded / a.total), (isNaN(this.progress) || 1 / 0 == this.progress) && (this.progress = 0)),
        ...
        (c.LOAD_TIMEOUT = 8e3),
            ...
            (b._addItem = function (a, b) {
                ...
                if (null != c) {
                    ...
                    null != d &&
                        (this._loadQueue.push(d),
                        this._loadQueueBackup.push(d),
                        this._numItems++,
                        this._updateProgress(),
                        this.maintainScriptOrder && c.type == createjs.LoadQueue.JAVASCRIPT && d instanceof createjs.XHRLoader && (this._scriptOrder.push(c), this._loadedScripts.push(null)));
                }
            }),
            (b._createLoadItem = function (a) {
                ...
                if (d) {
                    ...
                    if (e === !1) return null;
                    e === !0 || (null != e.src && (b.src = e.src), null != e.id && (b.id = e.id), null != e.tag && e.tag.load instanceof Function && (b.tag = e.tag), null != e.completeHandler && (b.completeHandler = e.completeHandler)),
        ...
        (b._loadTimeout = null),
            ...
            (b.load = function () {
                ...
                clearTimeout(this._loadTimeout),
                    ...
                    this._isAudio
                        ? ((b.onstalled = createjs.proxy(this._handleStalled, this)), b.addEventListener("canplaythrough", this._tagCompleteProxy, !1))
                        : ((b.onload = createjs.proxy(this._handleLoad, this)), (b.onreadystatechange = createjs.proxy(this._handleReadyStateChange, this)));
                ...
                (a.type == createjs.LoadQueue.SVG || a.type == createjs.LoadQueue.JSONP || a.type == createjs.LoadQueue.JSON || a.type == createjs.LoadQueue.JAVASCRIPT || a.type == createjs.LoadQueue.CSS) &&
    ...
    (function () {
        ...
        (b._request = null),
            ...
            (b._createXHR = function (a) {
                ...
                var g = null;
                return (
                    (g = a.method == createjs.LoadQueue.GET ? this.buildPath(a.src, this._basePath, a.values) : this.buildPath(a.src, this._basePath)),
